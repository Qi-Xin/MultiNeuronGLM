...
#     with open('statistics_null_filter'+socket.gethostname()+'.pickle', 'wb') as handle:
#         pickle.dump(statistics_null_filter, handle)
#     with open('statistics_null_output'+socket.gethostname()+'.pickle', 'wb') as handle:
#         pickle.dump(statistics_null_output, handle)
#     print(f"Finishing {(i+1)*50} permutation. ")
